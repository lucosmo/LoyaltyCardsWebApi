...
public interface IUserService
{
    ...
    Task<Result<UserDto>> GetUserByIdAsync(int? currentUserId);
    Task<Result<UserDto>> GetUserByIdAsync(int userId, int? currentUserId);
    Task<Result<UserDto>> GetUserByEmailAsync(string currentUserEmail);
