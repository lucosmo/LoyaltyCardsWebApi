...
public interface ICardRepository
{
    ...
    Task<Card?> DeleteAsync(int id, int userId, CancellationToken cancellationToken = default);
    ...
    Task<Card?> UpdateCardAsync(int id, UpdateCardDto updateCard, int userId, CancellationToken cancellationToken = default);
}
